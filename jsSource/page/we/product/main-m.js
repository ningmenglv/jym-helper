...
import "./style-m.less";
var ProductPage_M = /** @class */ (function (_super) {
    __extends(ProductPage_M, _super);
    function ProductPage_M() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ProductPage_M.prototype.render = function () {
        return (React.createElement("div", { id: "product-m", className: "page-m" },
    ...
    return ProductPage_M;
}(React.Component));
export default ProductPage_M;
