...
import ListDetil_M from "./main-m";
import ListDetil_PC from "./main-pc";
...
var ReportDetailPage = /** @class */ (function (_super) {
    ...
    ReportDetailPage.prototype.getReportDetail = function (guid) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                Axios.get(Constant.hosts.SERVER_OPER + "/api/Article/ArticleIdentifier", {
                    params: {
                        guid: guid
                    }
                }).then(function (res) {
    ...
    ReportDetailPage.prototype.render = function () {
        return (React.createElement("div", { id: "listDetil-page" }, isM ? (React.createElement(ListDetil_M, __assign({}, this.state))) : (React.createElement(ListDetil_PC, __assign({}, this.state)))));
    };
